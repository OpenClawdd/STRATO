...
export function createHomeController() {
  const controller = {
    render() {
      ...
      renderCards('home-favorites', favorites, 'Your shelf is empty. Favorite a game you want close by.', controller);
      renderCards('home-recent', recent, 'Nothing launched yet. Search anything, then launch instantly.', controller);
