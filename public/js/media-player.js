...
(function () {
  ...
  const LOFI_TRACKS = [
    ...
    },
    {
      title: "Study Beats",
      artist: "Lofi Girl",
      url: "https://stream.zeno.fm/4d6kbe0qen8uv",
    },
    {
      title: "Chill Radio",
      artist: "Lofi Records",
      url: "https://stream.zeno.fm/hmm0y7y0a8quv",
    },
    {
      title: "Dreamscape FM",
      artist: "Sleepy Fish",
  ...
  function updatePlayButton() {
    const playBtn =
      document.getElementById("btn-media-play") ||
      document.getElementById("mp-play-btn");
    if (playBtn) {
  ...
  function loadTrack(index) {
    ...
    const titleEl =
      ...
      document.getElementById("mp-track-title");
