  ...
  `;
        ...
        function initBrowser() {
                ...
                if (engineSelect) {
                        ...
                        engineSelect.onchange = () => {
                                ...
                                // Also update the transport if the connection is available
                                if (window.__stratoTransport?.connection) {
                                        const epoxyPath = "/epoxy-transport.mjs";
                                        const wispUrl = (location.protocol === "https:" ? "wss://" : "ws://") + location.host + "/wisp/";
                                        window.__stratoTransport.connection.setTransport(epoxyPath, [{ wisp: wispUrl }])
        ...
        function initGameOverlay() {
                ...
                if (closeBtn) {
                        closeBtn.onclick = () => {
                                if (window.StratoGameEngine) {
                                        ...
                                        $("#game-overlay").classList.remove("loading");
                ...
                if (fsBtn) {
                        fsBtn.onclick = () => {
                                if (window.StratoGameEngine) {
                                        StratoGameEngine.tryFullscreen();
                                } else {
                                        const ifr = $("#theater-iframe");
                                        if (ifr) {
