...
import { playableCatalog, clearCatalogMemo, normalizeGame } from '../../public/js/v5/core/catalog.js';
...
describe('STRATO Trust & Hardening', () => {
  beforeEach(() => {
    ...
    clearCatalogMemo();
    setGames([
      { id: 'good', reliability: 'green', name: 'Good Game', category: 'action', url: '/games/good' },
      { id: 'bad', reliability: 'red', name: 'Broken Game', category: 'action', url: '/games/bad' }
    ], normalizeGame);
  });
  ...
  it('preserves verified status during normalization', () => {
    const game = normalizeGame({ id: 'test', reliability: 'green', url: '/test' });
