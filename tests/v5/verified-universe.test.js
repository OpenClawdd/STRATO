...
describe("Verified Universe Catalog Gating", () => {
  const mockCatalog = [
    ...
    },
    {
      ...
      reliability: "yellow",
      category: "arcade",
      url: "https://remote.example/game",
    },
    {
      id: "yellow-remote-verified",
      name: "Yellow Remote Verified",
      reliability: "yellow",
      category: "arcade",
  ...
  it("excludes reliability:red games from the playable catalog", () => {
    ...
    expect(launchability(mockCatalog[2]).status).toBe(
      "remote-proxy-unverified",
    );
  });
});
