...
import {
  ...
  launchability,
  initHealthCache,
} from "../../public/js/v5/core/health.js";
import { searchGames, scoreGame } from "../../public/js/v5/core/search.js";
import {
  dailyPicks,
  surpriseCandidate,
} from "../../public/js/v5/core/picks.js";
...
const catalog = [
  {
    ...
    description: "Slide number tiles",
    url: "/games/2048/index.html",
    thumbnail: "/assets/2048.webp",
    reliability: "green",
  },
  {
    id: "space-run",
  ...
  },
  {
    ...
    name: "Harbor Candidate",
    category: "arcade",
    tags: ["remote"],
    description: "Needs proxy proof",
    url: "https://remote.example/unverified",
    reliability: "yellow",
  },
  {
    id: "remote-verified",
    name: "Gateway Confirmed",
    category: "arcade",
    tags: ["remote"],
    description: "Transport proven",
    url: "https://remote.example/verified",
    reliability: "yellow",
    proxyVerified: true,
  },
  {
...
describe("v5 search", () => {
  it("scores exact title matches above tag or description matches", () => {
    expect(scoreGame(catalog[0], "2048")).toBeLessThan(
      scoreGame(catalog[1], "arcade"),
    );
  });
...
describe("v5 picks and surprise", () => {
  it("produces deterministic launchable daily picks for the same date", () => {
    ...
    expect(dailyPicks(day).map((game) => game.id)).toEqual(
      dailyPicks(day).map((game) => game.id),
    );
    expect(
      dailyPicks(day).every((game) => launchability(game).launchable),
    ).toBe(true);
  });
    ...
    setGames(
      [
        ...catalog,
        {
          ...
          thumbnail: "/assets/space-exact.webp",
          reliability: "green",
        },
      ],
      normalizeGame,
