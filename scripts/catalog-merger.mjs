...
const SOURCES = [
  {
    path: ".strato-reports/repair/adfree-games.json",
    baseUrl: "https://adfree-sz-games.github.io",
  },
  {
    path: ".strato-reports/repair/3kh0-games.json",
...
SOURCES.forEach((source) => {
  ...
  console.log(
    `Processing source: ${path.basename(source.path)} (${sourceData.length} games)`,
  );
