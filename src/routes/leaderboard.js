...
router.get("/api/leaderboard/:gameId", async (req, res) => {
  try {
    ...
    // Sort by score descending, take top 10 using bounded sort to avoid full sort on large arrays
...
router.get("/api/leaderboard", async (req, res) => {
  try {
    ...
    // Extract top 25 users by XP using bounded sort, then map only the result
