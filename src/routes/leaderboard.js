...
router.get("/api/leaderboard", async (req, res) => {
  try {
    ...
    // ⚡ Bolt: Optimize global leaderboard by using bounded insertion sort (O(N) instead of O(N log N))
    // Also, defer the map transformation until after selecting the top N to save memory allocations.
