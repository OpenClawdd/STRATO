...
router.get("/api/leaderboard", async (req, res) => {
  try {
    ...
    // Defer object creation (mapping) until after sorting and slicing.
    // This reduces memory allocations from O(N) to O(25) short-lived objects.
    // We copy the array first with `[...allUsers]` to avoid mutating the cache.
