...
router.get("/api/leaderboard", async (req, res) => {
  try {
    ...
    // Optimization: avoid mapping all users before sorting to reduce memory overhead.
    // Ensure we copy the array first since store.getAll() returns direct cache references.
