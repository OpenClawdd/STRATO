...
router.get("/api/leaderboard/:gameId", async (req, res) => {
  try {
    ...
    // ⚡ Bolt: Use bounded insertion sort O(N) instead of full sort O(N log N)
...
router.get("/api/leaderboard", async (req, res) => {
  try {
    ...
    // ⚡ Bolt: Use bounded insertion sort to find top 25, then transform
    // Avoids mapping and sorting the entire users array
