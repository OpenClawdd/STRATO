...
router.get("/api/leaderboard/:gameId", async (req, res) => {
  try {
    ...
    // OPTIMIZATION: Use getTopN to avoid O(N log N) full array sort on large leaderboards
...
router.get("/api/leaderboard", async (req, res) => {
  try {
    ...
    // OPTIMIZATION: Use getTopN to avoid memory overhead of mapping entire user base before sorting
