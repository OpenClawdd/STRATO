...
router.get("/api/leaderboard/:gameId", async (req, res) => {
  try {
    ...
    // ⚡ Bolt Optimization: Using getTopN for O(N * K) bounded sort instead of O(N log N) full sort
...
router.get("/api/leaderboard", async (req, res) => {
  try {
    ...
    // ⚡ Bolt Optimization: Apply getTopN first, then map the bounded array to avoid mapping thousands of elements
