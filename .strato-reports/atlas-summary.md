...
Audit timestamp: `2026-07-14T15:28:23.474Z`
Total catalog games: **546**

## 📊 Reliability Breakdown
* **Green (Local Verified)**: **16**
* **Yellow (Active Remote)**: **134**
* **Red (Quarantined)**: **396**
* **Active checked playable candidates**: **150**
...
|---|---:|
| selenite.cc | 184 |
| play.frogiee.one | 113 |
| 1key.lol | 70 |
| lucideon.top | 63 |
| adfree-sz-games.github.io | 53 |
| 3kh0.github.io | 31 |
| localhost | 16 |
| krunker.io | 1 |
| slither.io | 1 |
...
* **Missing or Empty Thumbnails**: **0** games
* **Suspicious or Missing Categories**: **492** games
* **Duplicate Title Clusters**: **22** clusters
...
| **Civclicker** | civclicker (red), selenite-civclicker (red) |
| **Cookingmama** | cookingmama (red), cooking-mama (red) |
| **Cookingmama 2** | cookingmama-2 (red), cooking-mama-2 (red) |
| **Csgoclicker** | csgoclicker (red), csgo-clicker (yellow) |
| **Cubefield** | cubefield (yellow), cube-field (yellow) |
...
| **55** | Badicecream 2 | `badicecream-2` | `unknown` | `/games/game.html?game=/Games5/bad-ice-cream-2...` |
| **55** | Badicecream 3 | `badicecream-3` | `unknown` | `/games/game.html?game=/Games5/bad-ice-cream-3...` |
...
| **55** | Five Nights At Winstons | `five-nights-at-winstons` | `unknown` | `/games/game.html?game=/Games10/fnaw/index.htm...` |
...
| **50** | Happy Wheels | `happy-wheels` | `unknown` | `/games/game.html?game=https://mrsnailman.gith...` |
